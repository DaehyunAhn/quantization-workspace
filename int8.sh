...
QUANT_CONFIG_FILES=("configs/llm_compressor/w8a8_dynamic.yml" \
                "configs/llm_compressor/w8a8_static.yml")
...
for QUANT_CONFIG_FILE in ${QUANT_CONFIG_FILES[@]}; do
    ...
    CONFIG_NAME=$(basename "$QUANT_CONFIG_FILE" .yml)
    ...
    python quantize.py --model_id $MODEL_PATH \
        ...
        --compressor_type llm_compressor \
        --split train \
        --column messages \
